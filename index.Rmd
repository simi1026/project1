...
CHC_sites <- read.csv("~/project1/project1/CHC_sites_csv.csv")
MD_covid <- read.csv("~/project1/project1/MD_covid.csv")
party_df <- read.delim("~/project1/project1/party_df", header=FALSE)
```
